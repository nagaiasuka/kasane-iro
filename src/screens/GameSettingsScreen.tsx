...
export function GameSettingsScreen({ settings, onChange, onNext, stageName }: {
  stageName: string; settings: GameSettings; onChange: (settings: GameSettings) => void; onNext: () => void;
}) {
